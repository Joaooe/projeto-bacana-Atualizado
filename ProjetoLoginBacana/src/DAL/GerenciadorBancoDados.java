...
public ArrayList<CadastroUsuarioModel> filtrarUsuarioAtualizarDadosBanco(String id_user) {
    ...
    try {
        ...
        while (rs.next()) {
            ...
            CadastroUsuarioModel usuario = new CadastroUsuarioModel(idUser, userName, email, login, password, perfilUser);
        ...
        e.printStackTrace();
        System.out.println("Erro ao recuperar dados do banco.");
    } finally {
        try {
            if (rs != null) rs.close();
